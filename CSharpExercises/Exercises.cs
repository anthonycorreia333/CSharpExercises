...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        static public string ReverseStringHard(string word)
        {
            string reverse = "";
        ...
        static public string ReverseStringEasy(string text)
        {
        ...
        {
            DateTime[] nextDay = new DateTime[7];
        ...
        public static double MortgageCalculator(double loanBalance, double interestRate, int loanTerm, int paymentPeriod)
        {
            double payment = 0;
            double ratePer = (interestRate / 100) / paymentPeriod;
            double periods = loanTerm * paymentPeriod;
